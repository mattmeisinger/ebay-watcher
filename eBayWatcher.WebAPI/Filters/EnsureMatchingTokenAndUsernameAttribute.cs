...
namespace eBayWatcher.WebAPI.Filters
{
    public class EnsureMatchingTokenAndUsernameAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            var username = actionContext.Request.GetHeader("eBayWatcherUsername");
            var token = actionContext.Request.GetHeader("eBayWatcherToken");
            ...
            {
                log.Debug("eBayWatcherUsername was not set as an HTTP request header for this action.");
            }
